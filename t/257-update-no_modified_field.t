...
Test updating rows when the table doesn't have a 'modified' field.
...
my $name = 'test_update_nomodified_' . time();
lives_ok(
	sub
	{
		$object->insert(
...
ok(
	!exists( $object->{'modified'} ),
	'The object does not have a modified field.',
);
